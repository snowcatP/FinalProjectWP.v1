...
using ConvenienceStoreManagement.DB_Layer;
using ConvenienceStoreManagement.ItemsInOrderTableAdapters;
using System;
...
namespace ConvenienceStoreManagement.IF_Layer
{
    public partial class ExportReceipt : Form
    {
        ...
        public void ExportOrder(string idCus)
        {
            ...
            reportViewer1.LocalReport.ReportPath = "D:\\NAM 2_ Ky 2\\LT_WinDows\\Do_An\\FinalProject\\FinalProjectWP.v1\\ConvenienceStoreManagement\\IF_Layer\\ExportOrder.rdlc"; //vo folder da tai ve, copy path cua folder roi paste truoc ExportOrder.rdlc
